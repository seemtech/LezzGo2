...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        _backgroundLayerColor = [UIColor colorWithRed:140.0/255.0 green:198.0/255.0 blue:63.0/255.0  alpha:0.7];
...
- (void)updateMask {
    ...
    switch (self.defaultMaskType) {
        ...
        case SVProgressHUDMaskTypeBlack:{
            ...
            self.backgroundLayer.backgroundColor = self.defaultMaskType == SVProgressHUDMaskTypeCustom ? self.backgroundLayerColor.CGColor : [UIColor colorWithRed:140.0/255.0 green:198.0/255.0 blue:63.0/255.0  alpha:0.7].CGColor;
...
- (UIColor*)backgroundColorForStyle {
    if(self.defaultStyle == SVProgressHUDStyleLight) {
        return [UIColor colorWithRed:140.0/255.0 green:198.0/255.0 blue:63.0/255.0  alpha:0.7];
    } else if(self.defaultStyle == SVProgressHUDStyleDark) {
        return [UIColor colorWithRed:140.0/255.0 green:198.0/255.0 blue:63.0/255.0  alpha:0.7];
    } else {
