...
@property(retain,nonatomic) IBOutlet UIImageView *backgroundiamge;
@property(retain,nonatomic)IBOutlet UILabel *senderNamelable;

@property(retain,nonatomic)IBOutlet UIButton *imageShowButtonOtherSide;
@end
