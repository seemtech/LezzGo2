...
//        frame.origin.y = self.pinView.frame.origin.y+12;
//        frame.origin.x = self.pinView.frame.size.height/ 2.0;
...
//    }
    ...
    if (_hasCalloutView) {
        ...
        frame.origin.x = -frame.size.width+self.pinView.frame.size.width+24;
        self.calloutView.frame = frame;
    }
}
